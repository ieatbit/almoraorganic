        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400 mt-4">
              Bringing pure Himalayan products directly from the mountains to your doorstep.
            </p>
            <div className="flex space-x-4">
              <a href="https://facebook.com/almoraorganic" className="hover:text-amber-500 transition-colors">
                <span className="sr-only">Facebook</span>
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" />
                </svg>
              </a>
              <a href="https://instagram.com/almoraorganic" className="hover:text-amber-500 transition-colors">
              ...
              <a href="https://twitter.com/almoraorganic" className="hover:text-amber-500 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/products/turmeric" className="hover:text-amber-500 transition-colors">
                  Himalayan Turmeric
                </Link>
              </li>
              <li>
                <Link href="/products/honey" className="hover:text-amber-500 transition-colors">
                  Wild Forest Honey
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>
                <a href="mailto:info@almoraorganic.com" className="hover:text-amber-500 transition-colors">
                  info@almoraorganic.com
                </a>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-sm text-gray-400">
              © {new Date().getFullYear()} Almora Organic. All rights reserved.
            </p>
